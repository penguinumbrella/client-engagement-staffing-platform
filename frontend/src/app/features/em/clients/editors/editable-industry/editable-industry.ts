...
/** The client's industry, shown as a labeled value that turns into a text input on click, saving on blur/Enter and discarding on Escape. */
@Component({
  selector: 'app-editable-industry',
  imports: [FormsModule],
  templateUrl: './editable-industry.html',
  styleUrl: './editable-industry.css',
})
export class EditableIndustry {
