...
public interface ConsultantRepository
    ...
    Page<Consultant> findByActiveTrue(Pageable pageable);

    Page<Consultant> findByActiveTrueAndPrimarySkillAreaIn(Collection<String> skillAreas, Pageable pageable);
